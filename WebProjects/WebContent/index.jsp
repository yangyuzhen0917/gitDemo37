...
<!-- start banner_x -->
		<div class="banner_x center">
			...
			<div class="nav fl">
				<ul>
					<li><a href="./xqing.jsp" target="_blank">小米手机</a></li>
					<li><a href="">红米</a></li>
...
<!-- end banner_x -->
	...
	<!-- start danpin -->
		  ...
		  <div class="danpin center">
			...
			<c:forEach items="${sessionScope.list }" var="phone">
				<div class="mingxing fl">
					<div class="sub_mingxing"><a href=""><img src="${phone.storeimg }" alt=""></a></div>
					<div class="pinpai"><a href="">${phone.storename}</a></div>
					<div class="youhui">${phone.storeinfo }</div>
					<div class="jiage">${phone.storeprice }</div>
				</div>
			</c:forEach>
